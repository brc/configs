...
;
; Many of the following were configured in the Preferences UI...
;
; (gtk_accel_path "<Actions>/terminal-window/about" "")
; (gtk_accel_path "<Actions>/terminal-window/close-other-tabs" "")
; (gtk_accel_path "<Actions>/terminal-window/copy" "<Alt><Shift>c")
...
; (gtk_accel_path "<Actions>/terminal-window/paste" "<Alt><Shift>v")
...
;
; Unbind things that were automatically set
;
...
;
; Unbind other defaults NOT available in the UI...
;
